...
#define PLATFORM_OVERRIDE_S_EL2_TIMER_FLAGS       ((TIMER_POLARITY << 1) | (TIMER_MODE << 0))
#define PLATFORM_OVERRIDE_S_EL2_VIRT_TIMER_FLAGS  ((TIMER_POLARITY << 1) | (TIMER_MODE << 0))
...
#define PLATFORM_OVERRIDE_S_EL2_TIMER_GSIV        0x14
#define PLATFORM_OVERRIDE_S_EL2_VIRT_TIMER_GSIV   0x13
#define PLATFORM_OVERRIDE_PLATFORM_TIMER_COUNT    0x2

#define PLATFORM_OVERRIDE_SEC_EL2_PHY_TIMER_GSIV   PLATFORM_OVERRIDE_S_EL2_TIMER_GSIV
#define PLATFORM_OVERRIDE_SEC_EL2_PHY_TIMER_FLAGS  PLATFORM_OVERRIDE_S_EL2_TIMER_FLAGS
#define PLATFORM_OVERRIDE_SEC_EL2_VIR_TIMER_GSIV   PLATFORM_OVERRIDE_S_EL2_VIRT_TIMER_GSIV
#define PLATFORM_OVERRIDE_SEC_EL2_VIR_TIMER_FLAGS  PLATFORM_OVERRIDE_S_EL2_VIRT_TIMER_FLAGS
